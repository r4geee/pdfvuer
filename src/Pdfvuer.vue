  ...
  export default {
    ...
    methods: {
      drawScaled: function (newScale) {
        if (this.pdfViewer) {
          let pageWidthScale = this.$refs.container.offsetWidth / this.pdfViewer.viewport.width;
          let pageHeightScale = this.$refs.container.height / this.pdfViewer.viewport.height;
